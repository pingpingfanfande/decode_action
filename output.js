//Wed Dec 11 2024 04:45:55 GMT+0000 (Coordinated Universal Time)
...
const getNowDate = () => {
  ...
  var _0x4ee1e4 = _0x452c92.getFullYear();
  var _0x1543dd = _0x452c92.getMonth() + 1;
  var _0x4b7b90 = _0x452c92.getDate();
...
class Bar {
  ...
  async login() {
    ...
    let _0x546145 = SJS(6);
    let _0x2865c1 = "111111&111111&7.0.27&" + _0x42d576 + _0x546145;
    let _0x841371 = SHA1_Encrypt(_0x2865c1);
    let _0x468195 = "account=" + this.o + "&password=" + this.p;
    let _0x116ce7 = {
      "xy-api-signature": "" + _0x841371,
      "xy-api-timestamp": "" + _0x42d576 + _0x546145
    };
    let _0x40d5c0 = await task("post", "https://bb-member.wifiwx.com/auth/signIn?app_version=7.0.2&appid=m2oszr2ukmxzvqr4ai&package_name=com.hoge.android.wuxiwireless&language=Chinese&client_type=android", _0x116ce7, _0x468195);
  ...
  async signin() {
    ...
    let _0x581d96 = SJS(6);
    let _0x5d467c = "111111&111111&7.0.27&" + _0x273f4d + _0x581d96;
    let _0x57af14 = SHA1_Encrypt(_0x5d467c);
    let _0x492654 = getNowDate();
    let _0x1ae963 = "{\"sign_in_date\":\"" + _0x492654 + "\",\"access_token\":\"Bearer " + this.token + "\"}";
    let _0x28b77a = {
      "xy-api-signature": "" + _0x57af14,
      "xy-api-timestamp": "" + _0x273f4d + _0x581d96,
      "Member-User-Authorization": "Bearer " + this.token
    };
    let _0x54540a = await task("post", "http://bb-member.wifiwx.com/sign/in", _0x28b77a, _0x1ae963);
  ...
  async read() {
    ...
    let _0x58a580 = times(10);
    let _0x1d0678 = SJS(6);
    let _0x27a6e6 = "111111&111111&7.0.27&" + _0xedf550 + _0x1d0678;
    let _0x2a8ee1 = SHA1_Encrypt(_0x27a6e6);
    let _0xbb8ec5 = MD5Encrypt("platform=plus&task_key=" + this.readkey + "&timestamp=" + _0x58a580);
    let _0x45194d = {
      "xy-api-signature": "" + _0x2a8ee1,
      "xy-api-timestamp": "" + _0xedf550 + _0x1d0678,
      "Member-User-Authorization": "Bearer " + this.token
    };
    let _0x4be9ec = await task("post", "https://bb-member.wifiwx.com/task/trigger?access_token=Bearer " + this.token + "&appid=m2oszr2ukmxzvqr4ai&package_name=com.hoge.android.wuxiwireless&appkey=7fbab2da9b4c7cd2405ffa7e8097cc22&task_key=" + this.readkey + "&sign=" + _0xbb8ec5 + "&platform=plus&timestamp=" + _0x58a580, _0x45194d);
  ...
  async view() {
    ...
    let _0x4c6e04 = times(10);
    let _0x40e50d = SJS(6);
    let _0x401f4f = "111111&111111&7.0.27&" + _0x402bc5 + _0x40e50d;
    let _0x4c306d = SHA1_Encrypt(_0x401f4f);
    let _0x1baef3 = MD5Encrypt("platform=plus&task_key=" + this.viewkey + "&timestamp=" + _0x4c6e04);
    let _0x37a82e = {
      "xy-api-signature": "" + _0x4c306d,
      "xy-api-timestamp": "" + _0x402bc5 + _0x40e50d,
      "Member-User-Authorization": "Bearer " + this.token
    };
    let _0x1100a0 = await task("post", "https://bb-member.wifiwx.com/task/trigger?access_token=Bearer " + this.token + "&appid=m2oszr2ukmxzvqr4ai&package_name=com.hoge.android.wuxiwireless&appkey=7fbab2da9b4c7cd2405ffa7e8097cc22&task_key=" + this.viewkey + "&sign=" + _0x1baef3 + "&platform=plus&timestamp=" + _0x4c6e04, _0x37a82e);
  ...
  async listen_gb() {
    ...
    let _0x384141 = times(10);
    let _0x352949 = SJS(6);
    let _0x3eac0a = "111111&111111&7.0.27&" + _0x406a41 + _0x352949;
    let _0x3ccd5e = SHA1_Encrypt(_0x3eac0a);
    let _0x310c4f = MD5Encrypt("platform=plus&task_key=listen_gb&timestamp=" + _0x384141);
    let _0x2d4ba4 = {
      "xy-api-signature": "" + _0x3ccd5e,
      "xy-api-timestamp": "" + _0x406a41 + _0x352949,
      "Member-User-Authorization": "Bearer " + this.token
    };
    let _0x4e0ad4 = await task("post", "https://bb-member.wifiwx.com/task/trigger?access_token=Bearer " + this.token + "&appid=m2oszr2ukmxzvqr4ai&package_name=com.hoge.android.wuxiwireless&appkey=7fbab2da9b4c7cd2405ffa7e8097cc22&task_key=listen_gb&sign=" + _0x310c4f + "&platform=plus&timestamp=" + _0x384141, _0x2d4ba4);
  ...
  async live() {
    ...
    let _0x92e6a6 = times(10);
    let _0x3fb1e9 = SJS(6);
    let _0x574356 = "111111&111111&7.0.27&" + _0x5c49ad + _0x3fb1e9;
    let _0x2ce321 = SHA1_Encrypt(_0x574356);
    let _0x124215 = MD5Encrypt("platform=plus&task_key=live&timestamp=" + _0x92e6a6);
    let _0x3460e0 = {
      "xy-api-signature": "" + _0x2ce321,
      "xy-api-timestamp": "" + _0x5c49ad + _0x3fb1e9,
      "Member-User-Authorization": "Bearer " + this.token
    };
    let _0x556b41 = await task("post", "https://bb-member.wifiwx.com/task/trigger?access_token=Bearer " + this.token + "&appid=m2oszr2ukmxzvqr4ai&package_name=com.hoge.android.wuxiwireless&appkey=7fbab2da9b4c7cd2405ffa7e8097cc22&task_key=live&sign=" + _0x124215 + "&platform=plus&timestamp=" + _0x92e6a6, _0x3460e0);
  ...
  async share() {
    ...
    let _0x3023ea = times(10);
    let _0x2748bc = SJS(6);
    let _0x2fa5fa = "111111&111111&7.0.27&" + _0x443812 + _0x2748bc;
    let _0xb447f4 = SHA1_Encrypt(_0x2fa5fa);
    let _0x21588c = MD5Encrypt("platform=plus&task_key=share&timestamp=" + _0x3023ea);
    let _0x349ec6 = {
      "xy-api-signature": "" + _0xb447f4,
      "xy-api-timestamp": "" + _0x443812 + _0x2748bc,
      "Member-User-Authorization": "Bearer " + this.token
    };
    let _0x3aa6f5 = await task("post", "https://bb-member.wifiwx.com/task/trigger?access_token=Bearer " + this.token + "&appid=m2oszr2ukmxzvqr4ai&package_name=com.hoge.android.wuxiwireless&appkey=7fbab2da9b4c7cd2405ffa7e8097cc22&task_key=share&sign=" + _0x21588c + "&platform=plus&timestamp=" + _0x3023ea, _0x349ec6);
  ...
  async userinfo() {
    ...
    let _0x1a8fbd = times(10);
    let _0x3ba43f = SJS(6);
    let _0x261c31 = "111111&111111&7.0.27&" + _0x48af34 + _0x3ba43f;
    let _0x472c61 = SHA1_Encrypt(_0x261c31);
    let _0x36df85 = {
      "xy-api-signature": "" + _0x472c61,
      "xy-api-timestamp": "" + _0x48af34 + _0x3ba43f,
      "Member-User-Authorization": "Bearer " + this.token
    };
    let _0x3f4134 = await task("get", "https://bb-member.wifiwx.com/member/info?access_token=Bearer " + this.token + "&appid=m2oszr2ukmxzvqr4ai&package_name=com.hoge.android.wuxiwireless", _0x36df85);
...
function SJS(_0x3e61a5) {
  ...
  var _0x21c632 = _0x1d9971.length;
  var _0x2fa4c5 = "";
...
function SJSxx(_0x11bd91) {
  ...
  var _0x35a56f = _0x10beac.length;
  var _0x2aff9f = "";
...
function SHA256(_0x487a70) {
  ...
  return function (_0x30b444) {
    ...
    const _0x1c0bf9 = [1779033703, 3144134277, 1013904242, 2773480762, 1359893119, 2600822924, 528734635, 1541459225];
    const _0x5875e0 = new Array(64);
    let _0x355a3d;
    let _0x2e8116;
    let _0x18b0f3;
    let _0x3d4536;
